...
public class ProductModel implements Parcelable {
    ...
    @Exclude
    private boolean isLikedByUser = false;      // L'utilisateur a-t-il liké ce produit?

    @Exclude
    private boolean isFavoriteByUser = false;   // L'utilisateur a-t-il mis ce produit en favori?
    ...
    // ✅ Getters/Setters pour l'état utilisateur
    @Exclude
    ...
    @Exclude
    public void setFavoriteByUser(boolean favoriteByUser) {
        this.isFavoriteByUser = favoriteByUser;
    }
    ...
    // ✅ Cette méthode retourne le premier imageId (image principale)
    @Exclude
